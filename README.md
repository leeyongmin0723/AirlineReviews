...
긍부정 리뷰의 비율을 확인하기 위해 레이블 0과 1의
리뷰의 갯수를 각각 구하고 주피터랩으로 시각화 하여 그래프로 비교해보았다.
이와 같이 부정적인 리뷰가 긍정적인 리뷰보다 훨씬 많은것으로 파악된다.
<img src="0_1.png">
...
- Qatar Airways가 여러 해에 걸쳐 최고의 평점을 차지하며 고객 만족도를 유지하고 있습니다.
### 종합 평가: Top 5 항공사
...
종합 점수 = 리뷰수 점수 + 평균 평점 점수 + 긍정비율 점수 + 일관성 점수  →  최대합: 4.0
 ...
 * ### MobileBERT를 사용하여 학습한 결과
 ...
 - 각 단계의 loss와 Accuracy의 평균을 내어 나타내보면 아래와 같다. 
    ...
    |Accuracy| 0.5920 | 0.8080 | 0.8580 | 0.8620 |
