...
- 긍부정 리뷰의 비율을 확인하기 위해 레이블 0과 1의 리뷰의 갯수를 각각 구하고 주피터랩으로 시각화 하여 그래프로 비교해보았다. 이와 같이 부정적인 리뷰가 긍정적인 리뷰보다 훨씬 많은것으로 파악된다.
...
- Qatar Airways가 최근 여러 해에 걸쳐 최고의 평점을 차지하며 고객 만족도를 유지하고 있습니다.
